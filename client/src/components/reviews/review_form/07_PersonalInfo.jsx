  ...
  return (
    <>
      <div id="review-form-name">
        ...
        <input id="form-name" name="form-name" placeholder="jackson11!" onChange={(e) => props.handleOnChange(e.target.name, e.target.value)} />
      ...
      <div id="review-form-email">
        ...
        <input id="form-email" type="email" name="form-email" placeholder="Example: jackson11@email.com" onChange={(e) => props.handleOnChange(e.target.name, e.target.value)} />
